...
public class Laboratorio03nicolas extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        Laboratorio03nicolas cronometro = new Laboratorio03nicolas();
